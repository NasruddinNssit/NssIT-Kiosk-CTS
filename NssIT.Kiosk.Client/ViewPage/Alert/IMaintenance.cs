...
namespace NssIT.Kiosk.Client.ViewPage.Alert
{
    public interface IMaintenance
    {
        ...
        PayWaveSettlement.UpdateLocalCardSettlementSuccessTimeDelg UpdateLocalCardSettlementSuccessTimeHandler { get; }
        PayWaveSettlement.GetLocalLastCardSettlementSuccessTimeDelg GetLocalLastCardSettlementTimeHandler { get; }
    }
}