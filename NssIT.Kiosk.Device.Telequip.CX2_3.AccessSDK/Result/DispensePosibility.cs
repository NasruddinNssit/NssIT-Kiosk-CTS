...
using NssIT.Kiosk.Device.Telequip.CX2_3.CX2_3Decorator.Data;

namespace NssIT.Kiosk.Device.Telequip.CX2_3.AccessSDK.Result
{
	public class DispensePossibility : ICX2D3Result
	{
		...
		public bool IsDispensePossible
		{
			get
			{
				return ((LowCoinMsg == null) && (MachineOutOfSvcMsg == null));
			}
		}
