...
{
	[Serializable]
	public class UISkyWaySubmission : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.SkyWaySubmission;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }
		public string ErrorMessage { get; set; } = null;

		public CommunicationDirection CommuCommandDirection { get; } = CommunicationDirection.SendOneResponseOne;

		public bool IsIncludeSkyWay { get; private set; } = true;

		public UISkyWaySubmission(string processId, DateTime timeStamp, bool isIncludeSkyWay)
		{
			BaseNetProcessId = Guid.NewGuid();
			RefNetProcessId = BaseNetProcessId;
			ProcessId = processId;
			TimeStamp = timeStamp;
            IsIncludeSkyWay = isIncludeSkyWay;
		}
