...
{
	[Serializable]
	public class UIInsuranceAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.InsuranceAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		public UserSession Session { get; private set; } = null;
		public UIInsuranceAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
