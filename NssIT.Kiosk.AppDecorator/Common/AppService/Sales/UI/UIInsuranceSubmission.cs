...
{
	[Serializable]
	public class UIInsuranceSubmission : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.InsuranceSubmission;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }
		public string ErrorMessage { get; set; } = null;

		public CommunicationDirection CommuCommandDirection { get; } = CommunicationDirection.SendOneResponseOne;

		public bool IsIncludeInsurance { get; private set; } = true;

		public UIInsuranceSubmission(string processId, DateTime timeStamp, bool isIncludeInsurance)
		{
